...
file_to_load = os.path.join( "Resources", "election_results.csv") # I NEEDED TO CHANGE THE PATH TO SUIT MINE  
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_names:
        ...
        if (cVotes > winning_count) and (cVote_percentage > winning_percentage):
            ...
            county_largest_name = county
            county_largest_votes = cVote_percentage

    # 7: Print the county with the largest turnout to the terminal.
    county_largest = (
        f"-------------------------\n"
        f"Largest County Turnout: {county_largest_name}\n"
        f"-------------------------\n")
